      ...
      tap(async data => {
        ...
        switch (method) {
            ...
            for (const user of affectedUsers) {
              ...
              await this.notificationsQueue.add(
                "notification",
                {
                  ...
                  embed: new SUEmbedBuilder("ⓘ Exam has been added").setDescription(message).setColor(Color.SUCCESS).build(),
                },
                {
                  attempts: 3,
            ...
            for (const user of affectedUsers) {
              ...
              await this.notificationsQueue.add(
                "notification",
                {
                  ...
                  discordUserChannelId: user.discordUserChannelId,
                  url: "https://schoolutilities.net/school/2acf32a75-426e-48c6-894b-b5fdb2a886ff/planner?tab=timetable&startDate=2022-10-31&schoolClassUUID=453de6c12-f1a5-4bcd-b2ec-05515d46e063&detail=Ta7e602d1-e2e4-44a1-ad17-abc4373edcf0",
                  embed: new SUEmbedBuilder("ⓘ Exam has been updated").setDescription(message).setColor(Color.WARN).build(),
                },
                {
                  attempts: 3,
                  removeOnComplete: true,
          ...
          case "DELETE":
            for (const user of affectedUsers) {
              jobUUID = `${ID_STARTERS.NOTIFICATION}${uuidv4()}`;
              message = new NotificationBuilder().addText("The exam ").addBold(exam.timeTableExamDescription).addText(" has been deleted.").build();
              await this.notificationsQueue.add(
                "notification",
                {
                  userUUID: user.userUUID,
                  ...
                  discordUserChannelId: user.discordUserChannelId,
                  url: "https://schoolutilities.net/school/2acf32a75-426e-48c6-894b-b5fdb2a886ff/planner?tab=timetable&startDate=2022-10-31&schoolClassUUID=453de6c12-f1a5-4bcd-b2ec-05515d46e063&detail=Ta7e602d1-e2e4-44a1-ad17-abc4373edcf0",
                  embed: new SUEmbedBuilder("ⓘ Exam has been deleted").setDescription(message).setColor(Color.SUCCESS).build(),
                },
                {
                  attempts: 3,
                  removeOnComplete: true,
